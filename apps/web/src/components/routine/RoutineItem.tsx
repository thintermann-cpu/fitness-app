...
interface Props {
  ...
  isFirst?: boolean
  isLast?: boolean
  /** Drag handle attributes injected by the sortable wrapper */
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 1 }}>
            ...
            {pillarColor && (
              <span style={{ width: 6, height: 6, borderRadius: '50%', backgroundColor: pillarColor, flexShrink: 0 }} />
            )}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: 5, alignItems: 'center' }}>
        {pillar && (
          <button
            ...
            style={{ background: 'none', border: 'none', color: '#5a5248', fontSize: 13, cursor: 'pointer', padding: '4px 6px', lineHeight: 1 }}
            title="Bearbeiten"
          >
            ✎
          </button>
        ...
        <button
          ...
          style={{
            ...
            minWidth: 44, minHeight: 44, flexShrink: 0, touchAction: 'manipulation',
          }}
        >
          <span
            style={{
