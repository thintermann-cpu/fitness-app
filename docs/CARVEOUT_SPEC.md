...
| **Session BB** | **Runden- und Rep-Zähler im Timer** — Bei For Time und AMRAP liegt unter der Uhr „Runde fertig“ plus Reps +/−. Steht im Ablauf „N Runden“, gibt es bis 12 abhakbare Kreise (10 Rounds Grind). Eine fertige Runde setzt die Reps auf 0. AMRAP speichert den Score als `Runden` bzw. `4+12`, For Time bleibt die Zeit und die Zählung steht in den Notizen. |
