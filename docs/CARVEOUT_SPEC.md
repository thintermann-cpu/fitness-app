...
| `push_preferences` | Reminder-Einstellungen (morning/evening/wod/inactivity + Zeiten); **keine Migration vorhanden — manuell im Dashboard angelegt**; formale Migration ausstehend (siehe Roadmap) |
