...
│   ├── sessionStore.ts        # Zustand-Store (kein persist): isSessionActive: boolean; setSessionActive(v: boolean); genutzt von TimerView + KraftTimerView um laufende Session app-weit zu tracken (Swipe-Sperre, und AppShell blendet dabei Mobile-Header und Bottom-Nav aus)
...
*Letzte Aktualisierung: September 2026 — Session AW: Stripe-Return, Würfel live, Sidebar, Equipment-Toggle*
